...
[contact me](/contact/) to get it permanently.  Demo in `#kwbot` on Libera.
...
The channels are logged; see logs from `#nikola` (Libera, previously Freenode) [generated by KwBot](https://irclogs.getnikola.com/).
