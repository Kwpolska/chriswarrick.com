...
<div><label for="mail">Adr. pocztowy:</label> <input id="mail" name="mail" type="email"></div>
...
<div id="captchaimg"><label>CAPTCHA image:</label> <img src="http://kwpolska.co.cc/captcha.php?action=img"> (<a href="http://kwpolska.co.cc/captcha.php?action=text">Brak obrazków? -- otwórz w nowej karcie</a>)</div>
<div><em>Twój adres IP zostanie zapisany.</em></div>
<div><input type="submit" value="Wyślij" style="float: left;" onclick="Modalbox.show('http://kwpolska.co.cc/contact/send.php', {title: 'Wysyłanie...', params: Form.serialize('myform'), width: 600 }); return false;"><input type="button" value="Wróć" onclick="Modalbox.show('http://kwpolska.co.cc/polish/kontakt/', {title: 'Kontakt', width: 600}); return false;"</div>
</fieldset>
</form>
