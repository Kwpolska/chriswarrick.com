...
<form action="/contact/send.php" method="post" id="form">
    <article>
        ...
        <footer style="height: auto;">
            <label for="abq"><code style="border: none;"><?php echo $_SESSION['let']; ?></code> is the</label> <input id="abq" name="abq" required class="required" style="width: 75px;"> letter of the alphabet.*<br>
            <input type="submit" value="Submit" style="float: right;" id="submit">
            Your IP address will be saved.  All fields are required.<br>* please insert an ordinal number, eg. "first".  Anti-spam protection.
        </footer>
    </article>
</form>