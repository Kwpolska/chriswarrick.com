...
<head>
    <meta charset="UTF-8">
    <title>IP/User Agent — Kw’s Blog</title>
    <meta name="description" content="Basic browser information.">
    ...
    <link rel="apple-touch-icon" href="http://kwcdn.tk/apple-touch-icon.png">
        ...
        <link rel="stylesheet" href="http://kwcdn.tk/css/lite/light.min.css">    
...
<body id="ipua">
            <div id="container">
            <header>
                <span id="whereami">Kw’s Tools (@Kw’s Blog)</span>
                <h1>IP/User Agent</h1>
                <h2>Basic browser information.</h2>
            </header>
...
?>
            ...
            <footer><a href="http://kwpolska.tk/">home</a> — <a href="http://tools.kwpolska.tk/">tools</a><br>served by nginx, generated by hyde<br>copyright&nbsp;©&nbsp;2009-2012&nbsp;Kwpolska<br><a rel="license" href="http://creativecommons.org/licenses/by-nc-nd/3.0/">CC BY-NC-ND</a></footer>
